...
public class LoginButton extends Button implements OnClickListener {	
    ...
    public void setStyle(int style) {
    	int iconResId = com.kit.extend.weibo.R.drawable.com_sina_weibo_sdk_login_button_with_account_text;
    	switch (style) {
		case LOGIN_INCON_STYLE_1:
			iconResId = com.kit.extend.weibo.R.drawable.com_sina_weibo_sdk_login_button_with_account_text;
			break;
			
		case LOGIN_INCON_STYLE_2:
			iconResId = com.kit.extend.weibo.R.drawable.com_sina_weibo_sdk_login_button_with_frame_logo;
			break;
			
		case LOGIN_INCON_STYLE_3:
			iconResId = com.kit.extend.weibo.R.drawable.com_sina_weibo_sdk_login_button_with_original_logo;
			break;
