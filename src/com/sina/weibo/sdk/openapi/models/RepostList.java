...
public class RepostList {
    ...
    public static RepostList parse(String jsonString) {
        ...
        RepostList statuses = new RepostList();
        try {
            ...
            statuses.total_number    = jsonObject.optLong("total_number", 0);
    ...
    public RepostList() {}
    public RepostList(ArrayList<Status> statuses, int previousCursor,
                      int nextCursor, long totalNumber, boolean hasvisible) {
        statusList = statuses;
