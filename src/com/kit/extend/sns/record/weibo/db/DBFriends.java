...
public class DBFriends extends DB {
    ...
    public boolean insert(List<User> list) {
        ...
        try {
            ...
            for (User o : list) {
                ...
                values.put(DBFriends.FIELD_USERID, o.id);
                values.put(DBFriends.FIELD_SCREENNAME, o.screen_name);
                values.put(DBFriends.FIELD_NAME, o.name);
                values.put(DBFriends.FIELD_PROVINCE, o.province);
                values.put(DBFriends.FIELD_CITY, o.city);
                values.put(DBFriends.FIELD_LOCATION, o.location);
                values.put(DBFriends.FIELD_DESCRIPTION, o.description);
                values.put(DBFriends.FIELD_URL, o.url);
                values.put(DBFriends.FIELD_PROFILEIMAGEURL,
                        o.profile_image_url);
                values.put(DBFriends.FIELD_USERDOMAIN, o.domain);
                values.put(DBFriends.FIELD_GENDER, o.gender);
                values.put(DBFriends.FIELD_FOLLOWERSCOUNT,
                        o.followers_count);
                values.put(DBFriends.FIELD_FRIENDSCOUNT, o.friends_count);
                values.put(DBFriends.FIELD_STATUSESCOUNT, o.statuses_count);
                values.put(DBFriends.FIELD_FAVOURITESCOUNT,
                        o.favourites_count);
                values.put(DBFriends.FIELD_CREATEDAT, o.created_at);
                values.put(DBFriends.FIELD_FOLLOWING, o.following);
                values.put(DBFriends.FIELD_VERIFIED, o.verified);
                values.put(DBFriends.FIELD_VERIFIEDTYPE, o.verified_type);
                values.put(DBFriends.FIELD_ALLOWALLACTMSG, o.allow_all_act_msg);
                values.put(DBFriends.FIELD_ALLOWALLCOMMENT,
                        o.allow_all_comment);
                values.put(DBFriends.FIELD_FOLLOWME, o.follow_me);
                values.put(DBFriends.FIELD_AVATARLARGE, o.avatar_large);
                values.put(DBFriends.FIELD_ONLINESTATUS, o.online_status);
                values.put(DBFriends.FIELD_NEWESTSTATUSID, (o.status == null ? 0 : o.status.id) + "");
                values.put(DBFriends.FIELD_BIFOLLOWERSCOUNT,
                        o.bi_followers_count);
                values.put(DBFriends.FIELD_REMARK, o.remark);
                values.put(DBFriends.FIELD_LANG, o.lang);
                values.put(DBFriends.FIELD_VERIFIEDREASON,
                        o.verified_reason);
                values.put(DBFriends.FIELD_WEIHAO, o.weihao);
                //values.put(DBFriends.FIELD_STATUSID, o.getStatusId());
        ...
        try {
            ...
            if (!isExistById(o.id + "")) {
                String sql = "insert into " + TABLE_NAME + "(" + FIELD_USERID
                        ...
                        + o.domain + "','" + o.gender + "','"
                        + o.favourites_count + "','" + o.friends_count
                        + "','" + o.statuses_count + "','"
...
//                values.put(DBFriends.FIELD_USERID, o.id);
                ...
                values.put(DBFriends.FIELD_AVATARLARGE, o.avatar_large);
                values.put(DBFriends.FIELD_ONLINESTATUS, o.online_status);
                values.put(DBFriends.FIELD_NEWESTSTATUSID,
                        (o.status == null ? 0 : o.status.id) + "");
                values.put(DBFriends.FIELD_BIFOLLOWERSCOUNT,
                        o.bi_followers_count);
                values.put(DBFriends.FIELD_REMARK, o.remark);
                values.put(DBFriends.FIELD_LANG, o.lang);
                ...
                String whereClause = DBFriends.FIELD_USERID + "=?";
                String[] whereArgs = {String.valueOf(o.id)};
    ...
    public DBFriends open() throws SQLException {
        closeConnection();

        mDbHelper = new DBFriends(context);
