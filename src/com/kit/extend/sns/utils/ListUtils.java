package com.kit.extend.sns.utils;

import android.util.Log;

import com.kit.extend.sns.interfaces.IEqual;
...
//    }
    ...
    public static List<Object> replace(List<Object> objs, Object obj, Comparator comparator) {
        ...
        for (int i = 0; i < objs.size(); i++) {
            ...
            if (compare == 0) {
//                LogUtils.i(ListUtils.class, "compare true. value:" + compare);
...
//        LogUtils.i(ListUtils.class, "compare false");
        return false;
    }
